...
SECRET_KEY = 'django-insecure-l8@x8ty_uiz&zgl#+%a)r_vr$c65xngb^cpz$3h_8)aoz#u-79'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'python_suka',                 # Nom de la base de données
        'USER': 'root',                        # Nom d'utilisateur
        'PASSWORD': '',                        # Mot de passe vide pour root
...
MEDIA_URL = '/media/'  # URL à utiliser pour accéder aux fichiers médias
